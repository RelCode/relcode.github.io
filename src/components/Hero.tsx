	...
	return (
		<header className="resume-header">
			<div className="header-content">
				...
				<div className="header-text">
					...
					<p className="hero-pitch">
						I build and maintain production-grade web applications and AI-adjacent tooling — with a focus on
						reliability, performance, and clean engineering practices.
					</p>
				</div>
			</div>
			...
			<div className="social-links">
				...
				<span className="separator">|</span>
				<a
					href="https://www.linkedin.com/in/relebohile-nkosi-792b99106/"
					target="_blank"
